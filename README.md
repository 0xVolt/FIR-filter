...
- [1. Constructing an FIR Filter in C++ and Gnuplot](#1-constructing-an-fir-filter-in-c-and-gnuplot)
  ...
  - [1.3. Key](#13-key)
    ...
    - [1.3.3. Domains of a Signal](#133-domains-of-a-signal)
    - [1.3.4. Digital and Analog Signals](#134-digital-and-analog-signals)
      - [1.3.4.1. Digital Signals](#1341-digital-signals)
      - [1.3.4.2. Analog Signals](#1342-analog-signals)
      - [1.3.4.3. What's the difference?](#1343-whats-the-difference)
...
1. ![](assets/time-vs-frequency-6.png)
2. ![](assets/time-vs-frequency-3.png)
3. ![](assets/time-vs-frequency-2.png)
### 1.3.4. Digital and Analog Signals
#### 1.3.4.1. Digital Signals
